...
namespace seal
{
    namespace util
    {
        ...
        public:
            ...
            /**********************************************************/
            /* Pubic functions added by Ishtiyaque                */
            /************************************************************/

            SEAL_NODISCARD inline const Pointer<Pointer<std::uint64_t>> &base_change_matrix() const noexcept
            {
        ...
        /********************************************************************************************/
        /* Public functions added by Ishtiyaque */
        /*******************************************************************************************/

            SEAL_NODISCARD inline auto &base_q_to_Bsk_conv() const noexcept
            {
                return base_q_to_Bsk_conv_;
            }

            SEAL_NODISCARD inline auto &base_q_to_m_tilde_conv() const noexcept
            {
                return base_q_to_m_tilde_conv_;
            }

            SEAL_NODISCARD inline auto &neg_inv_prod_q_mod_m_tilde() const noexcept
            {
                return neg_inv_prod_q_mod_m_tilde_;
            } 

            SEAL_NODISCARD inline auto &prod_q_mod_Bsk() const noexcept
            {
                return prod_q_mod_Bsk_;
            } 

            SEAL_NODISCARD inline auto &inv_m_tilde_mod_Bsk() const noexcept
            {
                return inv_m_tilde_mod_Bsk_;
            }           

            SEAL_NODISCARD inline auto &coeff_count() const noexcept
            {
                return coeff_count_;
            }    

            SEAL_NODISCARD inline auto &inv_prod_q_mod_Bsk() const noexcept
            {
                return inv_prod_q_mod_Bsk_;
            }

            SEAL_NODISCARD inline auto &base_B_to_q_conv() const noexcept
            {
                return base_B_to_q_conv_;
            }  

            SEAL_NODISCARD inline auto &base_B_to_m_sk_conv() const noexcept
            {
                return base_B_to_m_sk_conv_;
            }

            SEAL_NODISCARD inline auto &inv_prod_B_mod_m_sk() const noexcept
            {
                return inv_prod_B_mod_m_sk_;
            } 

            SEAL_NODISCARD inline auto &prod_B_mod_q() const noexcept
            {
